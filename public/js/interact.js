/* interact.js v1.2.6 | https://raw.github.com/taye/interact.js/master/LICENSE */ (function (F) {
    ...
    function Fa(a) {
        return (a = a instanceof Xa ? a.getBoundingClientRect() : a.getClientRects()[0]) && { left: a.left, right: a.right, top: a.top, bottom: a.bottom, width: a.width || a.right - a.left, height: a.height || a.bottom - a.top };
    }
    function ua(a) {
        var b,
            c = Fa(a);
    ...
    function aa(a, b, c) {
        return (a = a.options.allowFrom) ? (t(c) ? (N(a) ? La(c, a, b) : t(a) ? Y(a, c) : !1) : !1) : !0;
    }
    function ab(a, b) {
        if (!b) return !1;
    ...
    function bb(a, b, c) {
        var d = 0,
            e = r.length,
            h = /mouse/i.test(a.pointerType || b) || 4 === a.pointerType,
            f;
        a = O(a);
    ...
    function G(a, b, c, d, e, h) {
        ...
        !Ma(k, c) ||
            (m && I && I.length) ||
            ((this.snap = { range: y.range, locked: y.locked, x: y.snappedX, y: y.snappedY, realX: y.realX, realY: y.realY, dx: y.dx, dy: y.dy }), y.locked && ((g.x += y.dx), (g.y += y.dy), (f.x += y.dx), (f.y += y.dy)));
        !Na(k, c) || (m && ia[c].restrict.elementRect) || !n.restricted || ((g.x += n.dx), (g.y += n.dy), (f.x += n.dx), (f.y += n.dy), (this.restrict = { dx: n.dx, dy: n.dy }));
        this.pageX = g.x;
        this.pageY = g.y;
        this.clientX = f.x;
        this.clientY = f.y;
        ...
        p
            ? "client" === E
                ? ((this.dx = f.x - a.startCoords.client.x), (this.dy = f.y - a.startCoords.client.y))
            ...
            : "client" === E
            ? ((this.dx = f.x - a.prevEvent.clientX), (this.dy = f.y - a.prevEvent.clientY))
        ...
        "resize" === c && a.resizeAxes
            ...
            : "gesture" === c &&
              ((this.touches = [u[0], u[1]]),
              m
                  ? ((this.distance = Ia(u, E)), (this.box = Ha(u)), (this.scale = 1), (this.ds = 0), (this.angle = Ja(u, void 0, E)), (this.da = 0))
                  : p || b instanceof G
                  ...
                  : ((this.distance = Ia(u, E)),
                    (this.box = Ha(u)),
                    (this.scale = this.distance / a.gesture.startDistance),
                    (this.angle = Ja(u, a.gesture.prevAngle, E)),
        ...
        m
            ...
            : ((this.timeStamp = new Date().getTime()),
              ...
              b instanceof G
                  ? ((b = this[eb] - a.prevEvent[eb]), (l = this[l] - a.prevEvent[l]), (c = this.dt / 1e3), (this.speed = fa(b, l) / c), (this.velocityX = b / c), (this.velocityY = l / c))
                  : ((this.speed = a.pointerDelta[E].speed), (this.velocityX = a.pointerDelta[E].vx), (this.velocityY = a.pointerDelta[E].vy)));
        (p || "inertiastart" === d) &&
            ...
            (p = 112.5 <= d && 247.5 > d),
            (l = 202.5 <= d && 337.5 > d),
            (this.swipe = { up: l, down: !l && 22.5 <= d && 157.5 > d, left: p, right: !p && (292.5 <= d || 67.5 > d), angle: d, speed: a.prevEvent.speed, velocity: { x: a.prevEvent.velocityX, y: a.prevEvent.velocityY } }));
    }
    function fb() {
    ...
    function hb(a, b, c) {
        ...
        var d = !1,
            ...
            h = null,
            f,
            g = x({}, b.curCoords.page),
            e = this.options;
        if (!a) return null;
        if (S.resize && e.resize.enabled)
            if (((d = e.resize), (f = { left: !1, right: !1, top: !1, bottom: !1 }), z(d.edges))) {
                for (var k in f) {
                    var y = f,
                        n = k,
                        u;
        ...
        for (c.preventDefault = fb; t(h); ) {
            for (f = 0; f < d.selectors.length; f++) {
                ...
                if (R(h, d.selectors[f]) && Y(g, e) && Y(g, h)) {
                    g = d.listeners[f];
                    c.currentTarget = h;
                    for (var k = 0; k < g.length; k++) if (g[k][1] === b) g[k][0](c);
                }
            }
            h = L(h);
        }
    ...
    function C(a, b) {
        ...
        if (ea(a)) {
            ...
            (c = V(a)),
                t(a, c) &&
                    (ba
                        ? (n.add(this._element, J.down, m.pointerDown), n.add(this._element, J.move, m.pointerHover))
                        : (n.add(this._element, "mousedown", m.pointerDown), n.add(this._element, "mousemove", m.pointerHover), n.add(this._element, "touchstart", m.pointerDown), n.add(this._element, "touchmove", m.pointerHover)));
        ...
        if (-1 === v(ja, a)) {
            ...
            ba
                ? ((J =
                  ...
                  n.add(a, J.down, m.selectorDown),
                  n.add(a, J.move, m.pointerMove),
                  n.add(a, J.over, m.pointerOver),
                  n.add(a, J.out, m.pointerOut),
                  n.add(a, J.up, m.pointerUp),
                  n.add(a, J.cancel, m.pointerCancel),
                  n.add(a, J.move, m.autoScrollMove))
                : (n.add(a, "mousedown", m.selectorDown),
                  n.add(a, "mousemove", m.pointerMove),
                  n.add(a, "mouseup", m.pointerUp),
                  n.add(a, "mouseover", m.pointerOver),
                  n.add(a, "mouseout", m.pointerOut),
                  n.add(a, "touchstart", m.selectorDown),
                  n.add(a, "touchmove", m.pointerMove),
                  n.add(a, "touchend", m.pointerUp),
                  n.add(a, "touchcancel", m.pointerCancel),
                  n.add(a, "mousemove", m.autoScrollMove),
                  n.add(a, "touchmove", m.autoScrollMove));
            n.add(b, "blur", jb);
            try {
                if (b.frameElement) {
    ...
    if (F) {
        var q = (function () {
            ...
            P = {},
            D = {
                base: { accept: null, actionChecker: null, styleCursor: !0, preventDefault: "auto", origin: { x: 0, y: 0 }, deltaSource: "page", allowFrom: null, ignoreFrom: null, _context: Q, dropChecker: null },
            ...
            p = {
                ...
                scroll: function () {
                    ...
                    d *= h;
                    e *= a;
                    if (1 <= d || 1 <= e) Ba(b) ? b.scrollBy(p.x * d, p.y * e) : b && ((b.scrollLeft += p.x * d), (b.scrollTop += p.y * e)), 1 <= d && (p.prevTimeX = c), 1 <= e && (p.prevTimeY = c);
            ...
            n = (function () {
                function a(b, c, d, h) {
                    var l,
                        ...
                        r = d;
                    if (p && p.events)
                        if ((e && ((q = n[m]), (I = v(q.supplied, d)), (r = q.wrapped[I])), "all" === c)) for (c in p.events) p.events.hasOwnProperty(c) && a(b, c, "all");
                        else {
                            if (p.events[c]) {
                                var t = p.events[c].length;
                                if ("all" === d) {
                ...
                return {
                    add: function (a, f, l, p) {
                        var m = v(k, a),
                            q = y[m];
                        q || ((q = { events: {}, typeCount: 0 }), (m = k.push(a) - 1), y.push(q), n.push(e ? { supplied: [], wrapped: [], useCount: [] } : null));
                                    ...
                                    t =
                                        ...
                                        function (e) {
                                            e.immediatePropagationStopped ||
                                                ...
                                                /mouse|click/.test(e.type) && ((e.pageX = e.clientX + V(a).document.documentElement.scrollLeft), (e.pageY = e.clientY + V(a).document.documentElement.scrollTop)),
                                                l(e));
                                        };
        ...
        xa.prototype = {
            ...
            pointerOver: function (a, b, c) {
                ...
                if (!this.prepared.name && this.mouse) {
                    ...
                    k && !ha(g, c, k) && (k = null);
                    k
                        ? ((this.target = g), (this.element = c), (this.matches = []), (this.matchElements = []))
                        : (B.forEachSelector(d),
                          this.validateSelector(a, b, e, h)
                              ? ((this.matches = e), (this.matchElements = h), this.pointerHover(a, b, this.matches, this.matchElements), n.add(c, ba ? J.move : "mousemove", m.pointerHover))
                              : this.target &&
                                (Y(f, c)
                                    ? (this.pointerHover(a, b, this.matches, this.matchElements), n.add(this.element, ba ? J.move : "mousemove", m.pointerHover))
            ...
            pointerHover: function (a, b, c, d, e, h) {
                ...
                if (!this.prepared.name && this.mouse) {
                    ...
                    c && c.options.styleCursor && (c._doc.documentElement.style.cursor = f ? gb(f) : "");
            ...
            pointerDown: function (a, b, c, d, e) {
                if (!e && !this.inertiaStatus.active && this.pointerWasMoved && this.prepared.name) this.checkAndPreventDefault(b, this.target, this.element);
                    ...
                    } else this.prepared.name || ((g = B.get(d)) && !Z(g, d, c) && aa(g, d, c) && (f = W(e || g.getAction(a, b, this, d), g, c)) && ha(g, d, f) && ((this.target = g), (this.element = d)));
                    var k = (g = this.target) && g.options;
                    !g || (!e && this.prepared.name)
                        ? this.inertiaStatus.active &&
                          d === this.element &&
                          W(g.getAction(a, b, this, this.element), g).name === this.prepared.name &&
                          (X(this.inertiaStatus.i), (this.inertiaStatus.active = !1), this.checkAndPreventDefault(b, g, this.element))
                        : ((f = f || W(e || g.getAction(a, b, this, d), g, this.element)),
                          this.setEventXY(this.startCoords, this.pointers),
                          f &&
                              (k.styleCursor && (g._doc.documentElement.style.cursor = gb(f)),
                              (this.resizeAxes = "resize" === f.name ? f.axis : null),
                              "gesture" === f && 2 > this.pointerIds.length && (f = null),
                              ...
                              (this.downTimes[h] = new Date().getTime()),
                              (this.downTargets[h] = c),
                              ra(this.downPointer, a),
                              sa(this.prevCoords, this.startCoords),
                              (this.pointerWasMoved = !1),
            ...
            setStartOffsets: function (a, b, c) {
                ...
                a
                    ? ((this.startOffset.left = this.startCoords.page.x - a.left),
                      ...
                      (e = "width" in a ? a.width : a.right - a.left),
                      (h = "height" in a ? a.height : a.bottom - a.top))
                ...
                if (a && c && c.relativePoints && c.relativePoints.length)
                    for (var f = 0; f < c.relativePoints.length; f++) this.snapOffsets.push({ x: this.startOffset.left - e * c.relativePoints[f].x + d.x, y: this.startOffset.top - h * c.relativePoints[f].y + d.y });
                else this.snapOffsets.push(d);
                a && b.elementRect
                    ? ((this.restrictOffset.left = this.startOffset.left - e * b.elementRect.left),
                      (this.restrictOffset.top = this.startOffset.top - h * b.elementRect.top),
                      (this.restrictOffset.right = this.startOffset.right - e * (1 - b.elementRect.right)),
                      (this.restrictOffset.bottom = this.startOffset.bottom - h * (1 - b.elementRect.bottom)))
            ...
            start: function (a, b, c) {
                this.interacting() ||
                    ...
                    (-1 === v(r, this) && r.push(this),
                    this.prepared.name || this.setEventXY(this.startCoords),
            ...
            pointerMove: function (a, b, c, d, e) {
                if (this.inertiaStatus.active) {
                    ...
                    this.setEventXY(this.curCoords, [{ pageX: d.x + this.inertiaStatus.sx, pageY: d.y + this.inertiaStatus.sy, clientX: h.x + this.inertiaStatus.sx, clientY: h.y + this.inertiaStatus.sy }]);
                ...
                var f,
                    g,
                    h = this.mouse ? 0 : v(this.pointerIds, O(a));
                this.pointerIsDown && !this.pointerWasMoved && ((f = this.curCoords.client.x - this.startCoords.client.x), (g = this.curCoords.client.y - this.startCoords.client.y), (this.pointerWasMoved = fa(f, g) > Qa));
                ...
                if (this.pointerIsDown)
                    if (d && this.pointerWasMoved && !e) this.checkAndPreventDefault(b, this.target, this.element);
                        ...
                        if (this.pointerWasMoved && (!this.inertiaStatus.active || (a instanceof G && /inertiastart/.test(a.type)))) {
                            if (!this.interacting() && (Ta(this.pointerDelta, this.prevCoords, this.curCoords), "drag" === this.prepared.name)) {
                                f = Math.abs(f);
                                g = Math.abs(g);
                                    ...
                                    if (!this.prepared.name) {
                                        ...
                                        g = function (a, b, d) {
                                            ...
                                            if (
                                                ...
                                                aa(a, l, c) &&
                                                R(l, b, d) &&
                                                "drag" === a.getAction(n.downPointer, n.downEvent, n, l).name &&
                                                ab(k, a) &&
                                                ha(a, l, "drag")
                                            )
                                                return a;
                            ...
                            if (this.prepared.name && this.target) {
                                g && this.start(this.prepared, this.target, this.element);
            ...
            resizeStart: function (a) {
                ...
                if (this.prepared.edges) {
                    ...
                    this.resizeRects = { start: b, current: x({}, b), restricted: x({}, b), previous: x({}, b), delta: { left: 0, right: 0, width: 0, top: 0, bottom: 0, height: 0 } };
            ...
            resizeMove: function (a) {
                ...
                if (b) {
                    ...
                    if (this.target.options.resize.preserveAspectRatio) {
                        ...
                        else if (m.top || m.bottom) e = h;
                    b.top && (g.top += h);
                    b.bottom && (g.bottom += h);
                    b.left && (g.left += e);
                    b.right && (g.right += e);
                    d
                        ? (x(k, g), "reposition" === c && (k.top > k.bottom && ((b = k.top), (k.top = k.bottom), (k.bottom = b)), k.left > k.right && ((b = k.left), (k.left = k.right), (k.right = b))))
                        : ((k.top = Math.min(g.top, f.bottom)), (k.bottom = Math.max(g.bottom, f.top)), (k.left = Math.min(g.left, f.right)), (k.right = Math.max(g.right, f.left)));
            ...
            pointerEnd: function (a, b, c, d) {
                ...
                if (this.interacting()) {
                    ...
                    var k = new Date().getTime(),
                        ...
                        m = (l = g && g.enabled && "gesture" !== this.prepared.name && b !== e.startEvent) && 50 > k - this.curCoords.timeStamp && f > g.minSpeed && f > g.endSpeed;
                    l &&
                        !m &&
                        (p || q) &&
                        ((g = {}),
                        (g.snap = g.restrict = g),
                        p && (this.setSnapping(this.curCoords.page, g), g.locked && ((r += g.dx), (t += g.dy))),
                        q && (this.setRestriction(this.curCoords.page, g), g.restricted && ((r += g.dx), (t += g.dy))),
                        r || t) &&
                        (n = !0);
                    if (m || n) {
                        ...
                        h.fire(e.startEvent);
                        m
                            ? ((e.vx0 = this.pointerDelta.client.vx),
                              (e.vy0 = this.pointerDelta.client.vy),
                              (e.v0 = f),
                              this.calcInertia(e),
                              (b = x({}, this.curCoords.page)),
                              (h = na(h, this.element)),
                              (b.x = b.x + e.xe - h.x),
                              (b.y = b.y + e.ye - h.y),
                              (h = { useStatusXY: !0, x: b.x, y: b.y, dx: 0, dy: 0, snap: null }),
                              (h.snap = h),
                              (r = t = 0),
                              p && ((b = this.setSnapping(this.curCoords.page, h)), b.locked && ((r += b.dx), (t += b.dy))),
                              q && ((h = this.setRestriction(this.curCoords.page, h)), h.restricted && ((r += h.dx), (t += h.dy))),
                              (e.modifiedXe += r),
                              (e.modifiedYe += t),
                              (e.i = T(this.boundInertiaFrame)))
                            : ((e.smoothEnd = !0), (e.xe = r), (e.ye = t), (e.sx = e.sy = 0), (e.i = T(this.boundSmoothEndFrame)));
                        e.active = !0;
                        return;
                    }
                ...
                this.dragging
                    ? ((e = new G(this, b, "drag", "end", this.element)),
                      (q = this.getDrop(e, b, this.element)),
                      (this.dropTarget = q.dropzone),
                      (this.dropElement = q.element),
                      (q = this.getDropEvents(b, e)),
                      q.leave && this.prevDropTarget.fire(q.leave),
                      q.enter && this.dropTarget.fire(q.enter),
                      q.drop && this.dropTarget.fire(q.drop),
                      q.deactivate && this.fireActiveDrops(q.deactivate),
                      h.fire(e))
                    : this.resizing
                    ? ((e = new G(this, b, "resize", "end", this.element)), h.fire(e))
                    : this.gesturing && ((e = new G(this, b, "gesture", "end", this.element)), h.fire(e));
                this.stop(b);
            },
            ...
            fireActiveDrops: function (a) {
                var b, c, d, e;
                for (b = 0; b < this.activeDrops.dropzones.length; b++) (c = this.activeDrops.dropzones[b]), (d = this.activeDrops.elements[b]), d !== e && ((a.target = d), c.fire(a)), (e = d);
            },
            ...
            getDrop: function (a, b, c) {
                ...
                for (var e = 0; e < this.activeDrops.dropzones.length; e++) {
                    ...
                    d.push(this.activeDrops.dropzones[e].dropCheck(a, b, this.target, c, h, this.activeDrops.rects[e]) ? h : null);
                }
                c = (b = d[0]) ? 0 : -1;
            ...
            getDropEvents: function (a, b) {
                ...
                this.dropElement !== this.prevDropElement &&
                    (this.prevDropTarget &&
                        ((c.leave = { target: this.prevDropElement, dropzone: this.prevDropTarget, relatedTarget: b.target, draggable: b.interactable, dragEvent: b, interaction: this, timeStamp: b.timeStamp, type: "dragleave" }),
                        (b.dragLeave = this.prevDropElement),
                        (b.prevDropzone = this.prevDropTarget)),
                    this.dropTarget &&
                        ((c.enter = { target: this.dropElement, dropzone: this.dropTarget, relatedTarget: b.target, draggable: b.interactable, dragEvent: b, interaction: this, timeStamp: b.timeStamp, type: "dragenter" }),
                        (b.dragEnter = this.dropElement),
                        (b.dropzone = this.dropTarget)));
                "dragend" === b.type &&
                    this.dropTarget &&
                    ((c.drop = { target: this.dropElement, dropzone: this.dropTarget, relatedTarget: b.target, draggable: b.interactable, dragEvent: b, interaction: this, timeStamp: b.timeStamp, type: "drop" }),
                    (b.dropzone = this.dropTarget));
                "dragstart" === b.type && (c.activate = { target: null, dropzone: null, relatedTarget: b.target, draggable: b.interactable, dragEvent: b, interaction: this, timeStamp: b.timeStamp, type: "dropactivate" });
                "dragend" === b.type && (c.deactivate = { target: null, dropzone: null, relatedTarget: b.target, draggable: b.interactable, dragEvent: b, interaction: this, timeStamp: b.timeStamp, type: "dropdeactivate" });
                "dragmove" === b.type &&
                    this.dropTarget &&
                    ((c.move = { target: this.dropElement, dropzone: this.dropTarget, relatedTarget: b.target, draggable: b.interactable, dragEvent: b, interaction: this, dragmove: b, timeStamp: b.timeStamp, type: "dropmove" }),
                    (b.dropzone = this.dropTarget));
                return c;
            },
            ...
            addPointer: function (a) {
                var b = O(a),
                    c = this.mouse ? 0 : v(this.pointerIds, b);
            ...
            collectEventTargets: function (a, b, c, d) {
                ...
                if ("tap" !== d || (!this.pointerWasMoved && this.downTargets[h] && this.downTargets[h] === c)) {
                    for (var f = [], g = [], k = c; k; ) l.isSet(k) && l(k)._iEvents[d] && (f.push(l(k)), g.push(k)), B.forEachSelector(e), (k = L(k));
            ...
            firePointers: function (a, b, c, d, e, h) {
                ...
                "doubletap" === h
                    ...
                    : (ra(g, b),
                      b !== a && ra(g, a),
                      (g.preventDefault = fb),
                      (g.stopPropagation = G.prototype.stopPropagation),
                      (g.stopImmediatePropagation = G.prototype.stopImmediatePropagation),
                      (g.interaction = this),
                      ...
                      (g.type = h),
                      (g.pointerId = O(a)),
                      (g.pointerType = this.mouse ? "mouse" : oa ? (N(a.pointerType) ? a.pointerType : [, , "touch", "pen", "mouse"][a.pointerType]) : "touch"));
                "tap" === h &&
                    ((g.dt = g.timeStamp - this.downTimes[f]),
                    (k = g.timeStamp - this.tapTime),
                    (l = !!(this.prevTap && "doubletap" !== this.prevTap.type && this.prevTap.target === g.target && 500 > k)),
                    (g["double"] = l),
                    (this.tapTime = g.timeStamp));
            ...
            setSnapping: function (a, b) {
                var c = this.target.options[this.prepared.name].snap,
                    ...
                    f;
                b = b || this.snapStatus;
                b.useStatusXY ? (h = { x: b.x, y: b.y }) : ((e = na(this.target, this.element)), (h = x({}, a)), (h.x -= e.x), (h.y -= e.y));
                b.realX = h.x;
                b.realY = h.y;
                ...
                for (var g = c.targets ? c.targets.length : 0, k = 0; k < this.snapOffsets.length; k++) {
                    ...
                    for (f = 0; f < g; f++)
                        (e = A(c.targets[f]) ? c.targets[f](l, m, this) : c.targets[f]) && d.push({ x: K(e.x) ? e.x + this.snapOffsets[k].x : l, y: K(e.y) ? e.y + this.snapOffsets[k].y : m, range: K(e.range) ? e.range : c.range });
                }
                var c = null,
                    k = !1,
                    n = 0,
            ...
            setRestriction: function (a, b) {
                ...
                (c = e)
                    ? "x" in e && "y" in e
                        ? ((e = Math.max(Math.min(c.x + c.width - this.restrictOffset.right, d.x), c.x + this.restrictOffset.left)), (c = Math.max(Math.min(c.y + c.height - this.restrictOffset.bottom, d.y), c.y + this.restrictOffset.top)))
                        : ((e = Math.max(Math.min(c.right - this.restrictOffset.right, d.x), c.left + this.restrictOffset.left)), (c = Math.max(Math.min(c.bottom - this.restrictOffset.bottom, d.y), c.top + this.restrictOffset.top)))
                    : ((e = d.x), (c = d.y));
                b.dx = e - d.x;
                b.dy = c - d.y;
            ...
            autoScrollMove: function (a) {
                ...
                if (b)
                    if (this.inertiaStatus.active) p.x = p.y = 0;
                        ...
                        var d,
                            e = this.target.options[this.prepared.name].autoScroll,
                            h = e.container || V(this.element);
                        Ba(h)
                            ? ((d = a.clientX < p.margin), (b = a.clientY < p.margin), (c = a.clientX > h.innerWidth - p.margin), (a = a.clientY > h.innerHeight - p.margin))
                            : ((h = Fa(h)), (d = a.clientX < h.left + p.margin), (b = a.clientY < h.top + p.margin), (c = a.clientX > h.right - p.margin), (a = a.clientY > h.bottom - p.margin));
                        p.x = c ? 1 : d ? -1 : 0;
                        p.y = a ? 1 : b ? -1 : 0;
        ...
        for (
            var m = {},
                lb = "dragStart dragMove resizeStart resizeMove gestureStart gestureMove pointerOver pointerOut pointerHover selectorDown pointerDown pointerMove pointerUp pointerCancel pointerEnd addPointer removePointer recordPointer autoScrollMove".split(
                    " "
                ),
                Ra = 0,
                Sa = lb.length;
        ...
        C.prototype = {
            setOnEvents: function (a, b) {
                "drop" === a
                    ? (A(b.ondrop) && (this.ondrop = b.ondrop),
                      A(b.ondropactivate) && (this.ondropactivate = b.ondropactivate),
                      A(b.ondropdeactivate) && (this.ondropdeactivate = b.ondropdeactivate),
                      A(b.ondragenter) && (this.ondragenter = b.ondragenter),
                      A(b.ondragleave) && (this.ondragleave = b.ondragleave),
                      A(b.ondropmove) && (this.ondropmove = b.ondropmove))
                    : ((a = "on" + a),
                      A(b.onstart) && (this[a + "start"] = b.onstart),
                      A(b.onmove) && (this[a + "move"] = b.onmove),
                      A(b.onend) && (this[a + "end"] = b.onend),
                      A(b.oninertiastart) && (this[a + "inertiastart"] = b.oninertiastart));
                return this;
            },
            ...
            setPerAction: function (a, b) {
                for (var c in b)
                    c in D[a] &&
                        (z(b[c])
                            ? ((this.options[a][c] = x(this.options[a][c] || {}, b[c])), z(D.perAction[c]) && "enabled" in D.perAction[c] && (this.options[a][c].enabled = !1 === b[c].enabled ? !1 : !0))
                            : H(b[c]) && z(D.perAction[c])
            ...
            dropzone: function (a) {
                return z(a)
                    ? ((this.options.drop.enabled = !1 === a.enabled ? !1 : !0),
                      ...
                      /^(pointer|center)$/.test(a.overlap) ? (this.options.drop.overlap = a.overlap) : K(a.overlap) && (this.options.drop.overlap = Math.max(Math.min(1, a.overlap), 0)),
            ...
            dropChecker: function (a) {
                return A(a) ? ((this.options.drop.checker = a), this) : null === a ? (delete this.options.getRect, this) : this.options.drop.checker;
            },
            accept: function (a) {
            ...
            resizable: function (a) {
                return z(a)
                    ? ((this.options.resize.enabled = !1 === a.enabled ? !1 : !0),
                      ...
                      /^x$|^y$|^xy$/.test(a.axis) ? (this.options.resize.axis = a.axis) : null === a.axis && (this.options.resize.axis = D.resize.axis),
                      H(a.preserveAspectRatio) ? (this.options.resize.preserveAspectRatio = a.preserveAspectRatio) : H(a.square) && (this.options.resize.square = a.square),
                      this)
                    : H(a)
            ...
            gesturable: function (a) {
                return z(a) ? ((this.options.gesture.enabled = !1 === a.enabled ? !1 : !0), this.setPerAction("gesture", a), this.setOnEvents("gesture", a), this) : H(a) ? ((this.options.gesture.enabled = a), this) : this.options.gesture;
            },
                        ...
                        z(this.options[e]) &&
                            ...
                            z(b)
                                ? (x(e, b),
                                  ...
                                  "snap" === a &&
                                      ("grid" === e.mode
                                          ? (e.targets = [l.createSnapGrid(x({ offset: e.gridOffset || { x: 0, y: 0 } }, e.grid || {}))])
                                          : "anchor" === e.mode
                                          ? (e.targets = e.anchors)
            ...
            styleCursor: function (a) {
                return H(a) ? ((this.options.styleCursor = a), this) : null === a ? (delete this.options.styleCursor, this) : this.options.styleCursor;
            },
            ...
            on: function (a, b, c) {
                ...
                if (-1 !== v(ca, a)) a in this._iEvents ? this._iEvents[a].push(b) : (this._iEvents[a] = [b]);
                    ...
                    if (!P[a]) for (P[a] = { selectors: [], contexts: [], listeners: [] }, d = 0; d < ja.length; d++) n.add(ja[d], a, qa), n.add(ja[d], a, Aa, !0);
                    a = P[a];
            ...
            off: function (a, b, c) {
                ...
                if (-1 !== v(ca, a)) (c = this._iEvents[a]) && -1 !== (e = v(c, b)) && this._iEvents[a].splice(e, 1);
                    ...
                    for (e = h.selectors.length - 1; 0 <= e; e--)
                        if (h.selectors[e] === this.selector && h.contexts[e] === this._context) {
                            var g = h.listeners[e];
                ...
                if (N(this.selector))
                    for (var a in P)
                        for (var b = P[a]; 0 < b.selectors.length; ) {
                            b.selectors[0] === this.selector && b.contexts[0] === this._context && (b.selectors.splice(0, 1), b.contexts.splice(0, 1), b.listeners.splice(0, 1), b.selectors.length || (P[a] = null));
        ...
        C.prototype.restrict = M(C.prototype.restrict, "Interactable#restrict is deprecated. See the new documentation for resticting at http://interactjs.io/docs/restriction");
        ...
        C.prototype.squareResize = M(C.prototype.squareResize, "Interactable#squareResize is deprecated. See http://interactjs.io/docs/#resize-square");
        ...
        ib(Q);
        (Oa in Element.prototype && A(Element.prototype[Oa])) ||
            (ka = function (a, b, c) {
        ...
        (function () {
            for (var a = 0, b = ["ms", "moz", "webkit", "o"], c = 0; c < b.length && !F.requestAnimationFrame; ++c) (T = F[b[c] + "RequestAnimationFrame"]), (X = F[b[c] + "CancelAnimationFrame"] || F[b[c] + "CancelRequestAnimationFrame"]);
            T ||
                (T = function (b) {
        ...
        "undefined" !== typeof exports
            ? ("undefined" !== typeof module && module.exports && (exports = module.exports = l), (exports.interact = l))
