 ...
 <div class="col-md-3 col-lg-3 col-xl-3">
    <div class="profile-widget">
        <div class="user-avatar">
            ...
            <a href="javascript:void(0)" onclick="Managelike({{$row->fav_id}},'remove')" class="fav-btn" title="Unlike">
...
<div class="text-center errorSection">
    <h4 class="text-center"> No Liked profile found however “Liking” allow you to add a list of your liked profiles from public search profiles page. <a class="text-primary" href="{{route('search.profile')}}">Click here</a> to add profiles in your liked list.
</h4>
</div>
@endif
