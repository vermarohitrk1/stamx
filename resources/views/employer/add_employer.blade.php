<form method="post" action="{{route('employer.post')}}" autocomplete="off" enctype="multipart/form-data" class="bv-form">
     @csrf
 
    <div class="form-group">
        <label>Company</label>
        <input class="form-control" type="text" value="" name="company" id="employer" >
   </div>
   <div class="form-group">
