    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-lg-8 col-xl-9">
                <div class=" col-md-12 ">
                   <a href="{{ URL::to('/') }}/dashboard" class="btn btn-sm btn-primary float-right btn-icon-only rounded-circle " >
...
<div class="row mt-3" id="blog_view">
     <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <h5 class="card-title d-flex justify-content-between" style="float:left;">
                    <span>Your application has been submitted.
                    </span> 
                    
                </h5>

                <h5 class="card-titl" style="float:right; margin-right:25px;">
               
                     <div class="cardh">
                                <div class="card-bodyhh">
                ...
                <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="file" name="question_<?php echo $i ?>" id="file" class="custom-input-file dropify" accept="pdf,txt,.doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,image/*"/>
                                </div>
                            </div>
                        </div>
...
<div class="text-right">
    ...
    <button type="button" class="btn btn-sm btn-secondary rounded-pill" ><a class="" href="{{ URL::to('/') }}/dashboard">Cancel</a></button>
</div>
{{ Form::close() }}
@endif
