<?php $page = "Meeting Schedules Canceled Bookings"; ?>
            ...
            <div class="col-md-12 col-12">
                ...
                <nav aria-label="breadcrumb" class="page-breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Meeting Scheduled Canceled Bookings</li>
                    </ol>
                </nav>
            </div>              
        </div>            
                ...
                <div class="table-md-responsive">
                    ...
                    <table class="table table-hover table-center mb-0" id="myTable">
                        <thead class="thead-light">
                            <tr>
                                <th class=" mb-0 h6 text-sm"> {{__('Booked By')}}</th>
...
<script type="text/javascript">
    ...
    var table = $('#myTable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ route('meeting.schedules.bookings.canceled') }}",
        columns: [           
