    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-lg-8 col-xl-9">
              ...
              <a href="{{ route('bookings.calendar') }}" class="btn btn-sm btn-primary float-right btn-icon-only  ml-2" >
...
<script type="text/javascript">
    ...
    var table = $('#myTable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ route('meeting.schedules.bookings') }}",
        columns: [           
            {data: 'user', name: 'user',orderable: false},
            {data: 'title', name: 'title',orderable: false},
            {data: 'date', name: 'date',orderable: true},
            {data: 'time', name: 'time',orderable: true},
            {data: 'accomplished', name: 'accomplished',orderable: false},
            {
                data: 'action', 
                name: 'action', 
                orderable: false, 
