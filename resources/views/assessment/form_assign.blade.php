                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-12">
                                <h2 class="breadcrumb-title">Assign Assessment Form</h2>
                                <nav aria-label="breadcrumb" class="page-breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="{{route('assessment.dashboard')}}">Assessments Dashboard</a></li>
    ...
    <div class="col-lg-12 order-lg-1">
        ...
        <span class="btn-inner--text"><i class="fas fa-reply"></i></span>
             ...
             @endif        
                ...
                <div class="card-body">
                    {{ Form::open(['route' => 'assessmentAssign.store','id' => 'new_input_form', 'name' => 'new_input_form','enctype' => 'multipart/form-data']) }}
...
@endif
                    ...
                    <div class="empty-section">
                        ...
                        <h6 class="text-danger">No member exist to assign assessment form, please add members! </h6>
                        <div class="text-right">
                        <a href="{{route('users')}}">
