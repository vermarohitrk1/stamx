    ...
    <div class="col-lg-8 order-lg-1">
        ...
        <span class="btn-inner--text"><i class="fas fa-reply"></i></span>
             ...
             @endif             
                ...
                <div class="card-body">
                    {{ Form::open(['route' => 'assessmentQuestion.store','id' => 'new_input_form', 'name' => 'new_input_form','enctype' => 'multipart/form-data']) }}
...
@endif
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-control-label">Question Points</label>
                                <input type="number" class="form-control" id="points" name="points"  value="{{ !empty($data->points) ? $data->points : ''}}"  step="1" placeholder="i.e 10" >
                            </div>
                            <div class="col-md-6">
...
<script>
    $(document).ready(function(){
      $.ajax({
       url:"{{route('assessmentForm.sidebar',!empty($form_id) ? encrypted_key($form_id,'encrypt') :0)}}?sidebar=form_question_add",
