	...
	<div class="row stemx">
			<div class="col-12 col-md-12 ">
                  ...
                  <h3 style="margin-top:15px !important;">@if(!empty($logoTxt)) {{ $logoTxt }} @else Your Logo Here @endif</h3>
                    ...
                    <!--    <a  class="nav-link" href="{{route('search.profile')}}">Mentoring</a>-->
                    <!--</li>-->
                    <!--<li class="{{ Request::is('search/courses') ? 'active' : '' }}">-->
                    <!--    <a class="nav-link" href="{{route('search.courses')}}">Education</a>-->
                    <!--</li>-->
                    <!--<li class="{{ Request::is('search/blogs') ? 'active' : '' }}">-->
                    <!--    <a class="nav-link" href="{{route('search.blogs')}}">Money</a>-->
                    <!--</li>-->
                    <!--<li class="{{ Request::is('search/profiles') ? 'active' : '' }}">-->
                    <!--    <a class="nav-link" href="{{route('search.profile')}}">Games</a>-->
                    <!--</li>-->
