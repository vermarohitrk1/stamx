...
<html lang="en">
  <head>
    @include('layout.frontend.home4.head')
     @stack('css')
  </head>
...
@include('layout.frontend.home4.header')
@endif
@yield('content')
@if(!Route::is(['chat','chat-mentee','voice-call','video-call','login','register','forgot-password']))
@include('layout.frontend.home4.footer')
@endif
@include('layout.frontend.home4.footer-scripts')
 @stack('script')
{{--Common Modal--}}
