...
<meta name="facebook-domain-verification" content="9a07dnq4tl88bbb2tkrnt70r9tnqm3" />
    ...
    <meta name="csrf-token" content="{{ csrf_token() }}">
		...
		<link rel="stylesheet" type="text/css" href="{{ asset('assets/home1/css/slick-slider/slick-theme.css')}}">
		<link rel="stylesheet" type="text/css" href="{{ asset('assets/home1/css/slick-slider/slick.css')}}">

		<link rel="stylesheet" type="text/css" href="{{ asset('assets/home1/css/mystyle.css')}}">
		<link rel="stylesheet" type="text/css" href="{{ asset('assets/home1/css/responsive.css')}}">
