...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-lg-8 col-xl-9">
			   ...
			   @elseif(Auth::user()->type=="mentor" || Auth::user()->type=="corporate" && 	  checkPlanModule("syndicatepayments") )
			   	   <a href="{{ route('certify.syndicate') }}" class="btn btn-sm btn btn-primary float-right mr-2 m-0">
                 <span class="btn-inner--text ">{{__('Syndicate')}}</span>
   ...
   @if(in_array('course_create_regular',$permissions) && in_array('course_create_master_class',$permissions))
    ...
    @endif
        ...
        @if($authuser->type == 'admin' || $authuser->type == 'mentor' || $authuser->type == 'corporate')
...
<div class="row mt-3 blockWithFilter">
                    <div class="col-md-12 col-lg-4 dash-board-list blue">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info">
                                <h3 data-id="courses">{{$CertifiesCount}}</h3>
                                <h6>{{__('Courses')}}</h6>															
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-4 dash-board-list pink">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info">
                                <h3 data-id="students">{{$student}}</h3>
                                <h6>{{__('Students')}}</h6>															
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-4 dash-board-list yellow">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info">
                                <h3 data-id="income">${{number_format((float)$income, 2, '.', '')}}</h3>
                                <h6>{{__('Income')}}</h6>															
                            </div>
                        </div>
                    </div>
