    ...
    <div class="card hover-shadow-lg">
        <div class="card-header border-0 pb-0">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-right">
                    <span class="badge badge-xs badge-success" data-toggle="tooltip" data-original-title="{{__('You are ') .__(ucfirst($authuser->type))}}">{{$authuser->type}}</span>
                </div>
            </div>
        </div>
        <div class="card-body text-center">
            <a href="{{ url('certify/show/'.$Certify->id) }}" class="avatar  avatar-lg hover-translate-y-n3">
                <img src="{{asset('storage')}}/certify/{{ $Certify->image }}" class="avatar " >
            </a>
            <h5 class="h6 my-4">
                <a href="{{ url('certify/show/'.$Certify->id) }}">{{ $Certify->name }}</a>
                <br>
            </h5>
        ...
        <div class="card-footer">
            <div class="actions d-flex justify-content-between px-4">
                <a href="{{ route('certify.edit',$Certify) }}" class="action-item" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
