...
<a href="{{ url('certify/show/'.encrypted_key($Certify->id,'encrypt')) }}" id="back" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2" >
    <span class="btn-inner--icon"><i class="fas fa-reply"></i></span>
</a>

<a style="float:right;" href="{{ url('certify/learnview/'.encrypted_key($Certify->id,'encrypt')) }}" class="btn btn-sm bg-white btn-icon rounded-pill mr-2 m-0">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12 mt-15">
                                    ...
                                    @endif
                                    <a href="#" data-url="{{ url('certify/curriculumCreate/'.$Certify->id) }}" data-ajax-popup="true" data-size="lg" data-title="{{__('Create Course Curriculum')}}" class="btn btn-primary btn-icon rounded-pill mr-2 m-0 add-chapter">
