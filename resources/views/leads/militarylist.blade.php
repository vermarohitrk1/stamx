    ...
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-12">
                                <h2 class="breadcrumb-title">Military</h2>
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 no_padding">
                    ...
                    <input type="checkbox" id="status_1" data-type="military"  data-corporate="army" class="check checklead" value="1" @if(!$lead->isEmpty())
...
@endif >
                    <label for="status_1" class="checktoggle">checkbox</label>
                        ...
                        <tr>
                            ...
                            <td class="text-left name mb-0 h6 text-sm"><div class="status-toggle">
                    <input type="checkbox" id="status_2" data-type="military" data-corporate="navy" class="check checklead"  value="1" @if(!$lead->isEmpty())
@foreach($lead as $data)
...
@endif>
                    <label for="status_2" class="checktoggle">checkbox</label>
                        ...
                        <tr>
                            ...
                            <td class="text-left name mb-0 h6 text-sm"><div class="status-toggle">
                    <input type="checkbox" id="status_3" data-type="military" data-corporate="airforce" class="check checklead" value="1" @if(!$lead->isEmpty())
@foreach($lead as $data)
...
@endif>
                    <label for="status_3" class="checktoggle">checkbox</label>
                        ...
                        <tr>
                            ...
                            <td class="text-left name mb-0 h6 text-sm"><div class="status-toggle">
                    <input type="checkbox" id="status_4" data-type="military" data-corporate="coastguard" class="check checklead" @if(!$lead->isEmpty())
@foreach($lead as $data)
...
@endif value="1">
                    <label for="status_4" class="checktoggle">checkbox</label>
                        ...
                        <tr>
                            ...
                            <td class="text-left name mb-0 h6 text-sm"><div class="status-toggle">
                    <input type="checkbox" id="status_5" data-type="military"  data-corporate="marinecorps" class="check checklead" @if(!$lead->isEmpty())
@foreach($lead as $data)
...
@endif" value="1">
                    <label for="status_5" class="checktoggle">checkbox</label>
                        ...
                        <tr>
                            ...
                            <td class="text-left name mb-0 h6 text-sm"><div class="status-toggle">
                    <input type="checkbox" id="status_6" data-type="military"  data-corporate="spaceforce" class="check checklead" @if(!$lead->isEmpty())
@foreach($lead as $data)
