        ...
        <div class="row">
            ...
            <div class="col-md-7 col-lg-8 col-xl-9">
                <div class=" col-md-12 ">      
                     ...
                     <a href="{{ route('choreCategory.index') }}" class="btn btn-sm btn btn-primary float-right mr-1" >
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-12">
                                <h2 class="breadcrumb-title">Chore Category Edit</h2>
                                <nav aria-label="breadcrumb" class="page-breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Chore Category Edit</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
...
<div class="row mt-3" id="blog_category_view">
  ...
  <div class="col-12">
      <div class="card">
                ...
                <div class="card-body">
                    {{ Form::open(['route' => 'choreCategory.update','id' => 'category update','enctype' => 'multipart/form-data']) }}
