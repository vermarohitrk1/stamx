...
<div class="col-lg-4 order-lg-2">
    ...
    <div class="col-lg-8 order-lg-1">
        ...
        <span class="btn-inner--text"><i class="fas fa-reply"></i></span>
              ...
              <div class="card-body">
                  <form class="simcy-form indexing-form fields-holder" action="{{ route('crmcustomQuestion@indexing') }}" data-parsley-validate="" loader="false" method="POST" enctype="multipart/form-data">
                   @CSRF
                           ...
                           <div class="row mt-3">
                               ...
                               <div class="col-md-2">
                                   <h6 class="text-muted">Action</h6>
                                        <a href="{{route('crmcustomQuestion.edit',['form_id' => encrypted_key($form->id,'encrypt'), 'id' => encrypted_key($question->id,'encrypt')])}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="javascript::void(0);" class="text-danger px-2 delete_record_model" data-url="{{route('crmcustomQuestion.destroy',encrypted_key($question->id,'encrypt'))}}" data-toggle="tooltip" data-original-title="{{__('Delete')}}">
...
<script src="{{ asset('assets/js/tabsmanager.js') }}"></script>
    ...
    $(document).ready(function(){
      $.ajax({
       url:"{{route('crmcustomForm.sidebar',!empty($form->id) ? encrypted_key($form->id,'encrypt') :0)}}?sidebar=form_questions",
   ...
   $(document).on("click", ".destroycrmcustomquestion", function(){
