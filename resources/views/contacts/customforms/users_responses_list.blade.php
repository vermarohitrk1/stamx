                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-12">
                                <h2 class="breadcrumb-title">Form Responses</h2>
...
<script src="{{ asset('assets/js/simcify.min.js') }}"></script>
    ...
    $(document).ready(function(){
      $.ajax({
       url:"{{route('crmcustomForm.sidebar',!empty($form->id) ? encrypted_key($form->id,'encrypt') :0)}}?sidebar=form_users_responses",
...
<script type="text/javascript">
        $(function () {
            var table = $('#myTableres').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('crmcustomForm.responseUsers',encrypted_key($id,'encrypt')) }}",
                columns: [
