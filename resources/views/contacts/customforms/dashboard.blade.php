                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-12">
                                <h2 class="breadcrumb-title">Surveys Dashboard</h2>
                                <nav aria-label="breadcrumb" class="page-breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Surveys Dashboard</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
      ...
      <div class="row blockWithFilter">
                    <div class="col-md-12 col-lg-3 dash-board-list blue">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info">
                                  ...
                                  <h3 data-id="form">@if(!empty($my_total_forms)){{ number_format($my_total_forms, 0) }} @else {{__('0')}} @endif</h3>
                                <h6>Forms</h6>															
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-3 dash-board-list pink">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info">
                                  ...
                                  <h3 data-id="question">@if(!empty($total_questions)){{number_format($total_questions, 0)}} @else {{__('0')}} @endif</h3>
                                <h6>Questions</h6>															
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-3 dash-board-list green">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info">
                                ...
                                <h3 data-id="response">@if(!empty($total_responses)){{ number_format($total_responses, 0) }} @else {{__('0')}} @endif</h3>
                                <h6>Responses</h6>	
                    ...
                    <div class="col-md-12 col-lg-3 dash-board-list yellow">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info">
                                <h3 data-id="folder">@if(!empty($total_folders)){{ count($total_folders) }} @else {{__('0')}} @endif</h3>
                                <h6>Folders</h6>	
...
<div class="row mt-3" id="blog_category_view"  >
     @if(in_array("manage_surveys",$permissions) || $user->type =="admin") 
       ...
       <div class="col-12" id="data-holder" data-view="survey dashboard">
