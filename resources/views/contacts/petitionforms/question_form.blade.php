...
<div class="col-lg-4 order-lg-2">
    ...
    <div class="col-lg-8 order-lg-1">
        ...
        <span class="btn-inner--text"><i class="fas fa-reply"></i></span>
                ...
                <div class="card-body">
                    {{ Form::open(['route' => 'petitioncustomQuestion.store','id' => 'new_input_form', 'name' => 'new_input_form','enctype' => 'multipart/form-data']) }}
...
<script>
    $(document).ready(function(){
      $.ajax({
       url:"{{route('petitioncustomForm.sidebar',!empty($form_id) ? encrypted_key($form_id,'encrypt') :0)}}?sidebar=form_question_add",
