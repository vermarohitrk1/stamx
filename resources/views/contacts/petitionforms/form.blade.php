                            ...
                            <div class="col-md-12 col-12">
                                ...
                                <nav aria-label="breadcrumb" class="page-breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{route('petitioncustom.dashboard')}}">Surveys Dashboard</a></li>
        ...
        <span class="btn-inner--text"><i class="fas fa-reply"></i></span>
             ...
             @endif             
                ...
                <div class="card-body">
                    ...
                    {{ Form::open(['route' => 'petitioncustomForm.store','id' => 'new_input_form', 'name' => 'new_input_form','enctype' => 'multipart/form-data']) }}
                    ...
                    <div class="text-right">
                       ...
                       @endif
                       @if(in_array("manage_petitions",$permissions) || $user->type =="admin")  
                        <a href="{{ route('petitioncustom.index') }}">
...
<script>
    $(document).ready(function(){
      $.ajax({
       url:"{{route('petitioncustomForm.sidebar',!empty($form->id) ? encrypted_key($form->id,'encrypt') :0)}}?sidebar=form_questions_preview",
