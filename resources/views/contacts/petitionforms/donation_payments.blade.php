                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-12">
                                <h2 class="breadcrumb-title">Petition Donations</h2>
                                <nav aria-label="breadcrumb" class="page-breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="{{route('petitioncustom.dashboard')}}">Petitions Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Petition Donations</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
...
<div class="row">
                    <div class="col-md-12 col-lg-4 dash-board-list yellow">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info">
                                 ...
                                 @php
                                $invoices = \App\UserPayment::where('entity_type','Petition Payment')->whereRaw('(paid_to_user_id='.$user->id.' OR user_id='.$user->id.')')->count();
                                @endphp
                                
                                  <h3>{{!empty($invoices)?$invoices:0}}</h3>
                    ...
                    <div class="col-md-12 col-lg-4 dash-board-list pink">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info">
                                @php
                                $totalpaid = \App\UserPayment::where('entity_type','Petition Payment')->where('user_id',$user->id)->sum('amount');
                                @endphp
                                <h3>{{format_price(!empty($totalpaid)?$totalpaid:0)}}</h3>
                                <h6>Total Donated</h6>	
                    ...
                    <div class="col-md-12 col-lg-4 dash-board-list green">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info">
                                @php
                                $earned = \App\UserPayment::where('entity_type','Petition Payment')->where('paid_to_user_id',$user->id)->sum('amount');
                                @endphp
                                <h3>{{format_price(!empty($earned)?$earned:0)}}</h3>
          ...
          <div class="card-body ">
              <form class="form-inline">
                        <div class="form-group mx-sm-3 mb-2">
                          <label for="filter_status" class="sr-only">Donation Type</label>
    ...
    $(function () {
        var table = $('#example').DataTable({
            ...
            serverSide: true,
             "bFilter": false,
             ajax: {
                        url: "{{ route('user.petition.invoices') }}",
                        data: function (d) {
