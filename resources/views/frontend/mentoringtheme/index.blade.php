				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-lg-4 d-flex flex-wrap">
							<div class="allcourse-card">
								<div class="allcourse-img">
									<img src="img/course/c3.jpg" alt="" class="img-fluid">
								</div>
						...
						<div class="col-md-4 col-lg-4 d-flex flex-wrap">
							<div class="allcourse-card">
								<div class="allcourse-img">
									<img src="img/course/c1.jpg" alt="" class="img-fluid">
								</div>
								<div class="allcourse-content">
						...
						<div class="section-btn m-auto">
                                                    <a href="{{route('search.courses')}}" class="btn btn-course">View all Courses <i class="fas fa-caret-right right-nav-white"></i></a>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="popular-course-section">
				<div class="container">
					...
					<div class="row">
						...
						<div class="section-btn m-auto">
                                                    <a href="{{route('search.courses')}}" class="btn btn-course">View all <i class="fas fa-caret-right right-nav-white"></i></a>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="instructor-section bg-grey">
				<div class="container">
					...
					<div class="row">
						...
						<div class="section-btn m-auto">
                                                    <a href="{{route('search.profile')}}" class="btn btn-course">Search an Instructor <i class="fas fa-caret-right right-nav-white"></i></a>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="featured-card bg-dark-grey">
								...
								<a href="{{route('search.courses')}}" class="text-white">View More <i class="fas fa-caret-right right-nav-grey"></i></a>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="featured-card bg-primary">
								...
								<p class="text-white">Courses for all levels cover technical skills, creative techniques, business strategies, and more. We have collected all of the necessary effective study.</p>
								<a href="{{route('search.profile')}}" class="text-white">View More <i class="fas fa-caret-right right-nav-white"></i></a>
							</div>
						</div>
					</div>
				</div>
