@extends('layout.frontend.home2.mainlayout')
@section('content')		
<div class="container-fluid">
	<div class="row m-0 p-0">
		<div class="col-12 video-section m-0 p-0">
			<video autoplay muted loop id="myVideo">
			  <source src="{{asset('storage')}}/app/{{ env('FRONTEND_THEME_BACKGROUND_VIDEO')??'' }}" type="video/mp4">
			</video>
		</div>
	</div>
	<div class="">
		...
		<div class="row">
			<div class="col-12 col-md-12 main-hero shitty-hero" >
					...
					<div class="row d-flex align-items-center">
						<div class="col-12 col-md-12 col-lg-12 mb3 ">
							<div class="hero-left-content">
								...
								<p class="hero-p text-center">We buiilt Banking so you don’t have to. Get start with modern banking, instantly!</p>
								<div class="button-divs text-center">
									...
									<div class="">
										<a href=""><img src="{{ asset('assets/home2/images/play.png')}} " class="img-fluid pr-2">  Demo Video</a>
									</div>
								...
								<div class="mt-5">
									<img src="{{ asset('assets/home2/images/main-image.png')}}" class="img-fluid d-block d-md-none" >
								</div>
	...
	<div class="row d-none d-md-block">
		<div class="col-12 main-image-section">
			<div class="container">
				<img src="{{ asset('assets/home2/images/main-image.png')}}" class="img-fluid min-imge">
			</div>
			<!-- contaienr end -->
		</div>
		<!-- main-image-section  -->
			...
			<div class="container">
				<div class="row d-flex align-items-center">
					<div class="col-12 col-md-6 mb3 paybe-left ">
						<img src="{{ asset('assets/home2/images/small-line.png')}}" class="lin">
						...
						<img src="{{ asset('assets/home2/images/onlyimage.png')}}" class="img-fluid d-block d-md-none m-auto">
						...
						<div class="apps-icons text-center text-md-left">
							<div class="text-left">
								<a href="">
									<img src="{{ asset('assets/home2/images/app-store.png')}}" class="img-fluid">
								</a>
							</div>
							<div class="paybelink">
								<a href=""><img src="{{ asset('assets/home2/images/play-store.png')}} " class="img-fluid"></a>
							</div>
						</div>
						<!-- button divs end -->
					</div>
					...
					<div class="col-12 col-md-6 paybe-right order-1 order-md-2 d-none d-md-block ">
						<img src="{{ asset('assets/home2/images/paybe-right.png')}}" class="img-fluid">
					</div>
					<!-- paybe right end -->
				</div>
				<!-- row end -->
			...
			<div class="container">
				<div class="row ">
					<div class="col-12 col-md-6 paybe-right">
						<img src="{{ asset('assets/home2/images/accept-payment.png')}}" class="img-fluid">
					</div>
	...
	<div class="row">
		<div class="col-12 col-md-12 testimonal-section py-50">
          ...
          <div class="testimonial">
            <div class="pic">
              <img src="{{ asset('assets/home2/images/pic1.png')}}" alt="">
            </div>
            <p class="description">
