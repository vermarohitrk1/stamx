    ...
    <div class="swiper-container mySwiper">
	  ...
	  @foreach($Photobooth as $_Photobooth)
		...
		<div class="overlay"></div>
          <img src="{{ asset('storage/photobooth/'.$_Photobooth->template) }}" />
		  
        </div>
		
		<div class="_button_content">        
		<div class="button_sec">
	@if($_Photobooth->type == 'text')
		<a class="button" href="{{url('photobooth/create/photo/'. encrypted_key($_Photobooth->id, 'encrypt'))}}">Add Text + Create Photo</a>
	@else
    <a class="button" href="{{url('photobooth/create/photo/'. encrypted_key($_Photobooth->id, 'encrypt'))}}">Create {{ $_Photobooth->type }}</a>
