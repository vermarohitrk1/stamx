...
<div class="content">
    ...
    <a href="#" class="btn btn-sm btn btn-primary float-right ml-2 " data-url="{{ route('task.categories.create') }}" data-ajax-popup="true" data-size="lg" data-title="{{__('Add Category
        ')}}">
    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-12 col-12">
                <h2 class="breadcrumb-title">Task Categories</h2>
                <nav aria-label="breadcrumb" class="page-breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{route('task.categories')}}">Task</a></li>
