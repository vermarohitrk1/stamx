...
@section('title')
@if(!empty($title)){{ ucwords($title, 0) }} @else {{__('Page')}} @endif
@endsection
@push('theme-script')
...
@section('action-button')
      <a href="{{ route('assessment.dashboard') }}" class="btn btn-sm bg-white btn-icon rounded-pill mr-1 ml-1">
        <span class="btn-inner--text text-dark"><i class="fa fa-grip-horizontal" ></i> {{__('Dashboard')}}</span>
    </a>
