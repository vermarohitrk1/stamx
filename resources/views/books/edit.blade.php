                     ...
                     <input type="text" class="form-control" name="price" value="{{$book->price}}" placeholder="Price" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="author" value="{{$book->author}}" placeholder="Author" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="marketplace" value="{{$book->marketplace}}" placeholder="Marketplace" required>
                            </div>
                        </div>
                    </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
						    <div class="row">
						        <div class="col-md-12">
						            ...
						            @if(!empty($book->image))
									<input type="file" name="image" class="custom-input-file croppie" default="{{asset('storage')}}/books/{{ $book->image }}" crop-width="600" crop-height="600"  accept="image/*">
