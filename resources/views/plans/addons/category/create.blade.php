    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-12 col-12">
                <h2 class="breadcrumb-title">Add-On Create category</h2>
                <nav aria-label="breadcrumb" class="page-breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('plans.addons.category') }}">Add-On Category</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Add-On Create Category</li>
                    </ol>
                </nav>
            </div>              
        </div>            
...
<div class="row mt-3" id="blog_view">
  ...
  {{ Form::open(['route' => ['plans.addons.category.store'],'id' => 'create_addons','class'=>'pl-3 pr-3','enctype' => 'multipart/form-data']) }}
