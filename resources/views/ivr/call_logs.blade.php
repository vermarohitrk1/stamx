                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-md-12 col-12">
                                <h2 class="breadcrumb-title">Call History</h2>
                ...
                <div class="row" id="blog_view">
                     <div class="col-12">
                        ...
                        <div class="form-group mx-sm-3 mb-2">
                          <label for="filter_status" class="sr-only">Start At</label>
                          <input type="date" id="start_at" name="start_at" title="Start At" class="form-control" />
                          
                        </div>
                        <div class="form-group mx-sm-3 mb-2">
                          <label for="filter_status" class="sr-only">End At</label>
                          <input type="date" id="end_at" name="end_at" title="End At" class="form-control" />
                          
                        </div>
                        <div class="form-group mx-sm-3 mb-2">
                            <button type="reset" id="formbutton"   class="form-control btn btn-sm btn-danger">Clear</button>
