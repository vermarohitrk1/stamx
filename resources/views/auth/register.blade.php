            ...
            <div class="account-box">
                <div class="login-right">
                    ...
                    <form id="register" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            @if(empty($domain_roles) || (!empty($domain_roles) && sizeof($domain_roles)==1))
                            <input  type="hidden" name="role" value="{{(!empty($domain_roles) && count($domain_roles)==1) ? $domain_roles[0]:'admin'}}">
                            @else
                            
                            <label class="form-control-label">Get Registered For</label>
                        ...
                        @if(!empty($_GET['become']) && $_GET['become']=='instructor')
                        <div class="form-group">
                            <div class="custom-control custom-control-xs custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="instructor" id="instructor">
                                <label class="custom-control-label" for="instructor">Would You Like to be get registered as a Instructor?</label>
                            </div>
                        </div>
                        @endif
