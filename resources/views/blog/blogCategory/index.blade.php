...
<div class="content">
    ...
    <a href="#" class="btn btn-sm btn btn-primary float-right ml-2 " data-url="{{ route('blog.category.create') }}" data-ajax-popup="true" data-size="lg" data-title="{{__('Add Category
        ')}}">
